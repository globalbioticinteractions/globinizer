...
public class CmdLineIT {
    ...
    public void list() {
        ...
        Assert.assertEquals(actual.getObjects().get(0).getClass(), CmdLine.CommandList.class);
    ...
    public void updateRun() {
        ...
        JCommander actual = jc.getCommands().get(jc.getParsedCommand());
        Assert.assertEquals(actual.getObjects().size(), 1);
        Assert.assertEquals(actual.getObjects().get(0).getClass(), CmdLine.CommandUpdate.class);
    ...
    public void testRun() {
        ...
        JCommander actual = jc.getCommands().get(jc.getParsedCommand());
        Assert.assertEquals(actual.getObjects().size(), 1);
        Assert.assertEquals(actual.getObjects().get(0).getClass(), CmdLine.CommandTest.class);
    ...
    private void assertUpdateCmd(JCommander jc) {
        ...
        Assert.assertEquals(cmd.getClass(), CmdLine.CommandUpdate.class);
        assertThat(((CmdLine.CommandUpdate) cmd).getCacheDir(), is("./bla"));
    }
